      ...
      if (chassis.odom_enabled() && !chassis.pid_tuner_enabled()) {
        ...
        if (ez::as::page_blank_is_on(0)) {
          ...
          ez::screen_print(
            ...
            "Intake Motor Torque: " + std::to_string(sprockets.intake_motor.get_torque() > 0.3) + " Nm\n" + 
            "Low Motor Torque: " + std::to_string(sprockets.low_motor.get_torque() > 0.3) + " Nm\n" + 
            "Middle Motor Torque: " + std::to_string(sprockets.middle_motor.get_torque() > 0.3) + " Nm\n" +
            "Ethan \"Goon\" Chen",
            1
          );
        }
